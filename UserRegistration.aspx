<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserRegistration.aspx.cs" Inherits="KredasInfra_v2_28May2024.UserRegistration" %>
...
<body>
    ...
    <td>
        <asp:TextBox ID="MiddleName_txt" runat="server"></asp:TextBox>
...
<tr>
    ...
    <td>
        <asp:DropDownList ID="city_ddl" runat="server" AutoPostBack="True" OnSelectedIndexChanged="District_ddl_SelectedIndexChanged"></asp:DropDownList>
    </td>
</tr>
